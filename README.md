...
* Cards para os automóveis
* Informações e preços dos veículos
* Seção de contato
* Design responsivo
...
Futuramente, o projeto poderá receber novas funcionalidades utilizando JavaScript, como:
...
⭐ Projeto desenvolvido com o objetivo de aprender, praticar e evoluir na programação.
